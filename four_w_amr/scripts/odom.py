...
class OdomCalculator(Node):
	...
	def __init__(self):
		...
		self.ticks_meter = 18830  # You need to set this value based on your encoder ticks and wheel diameter
		self.base_width = 0.703834  # Set the base width of your 4WD robot
	...
	def update(self):
		...
		q_rot = quaternion_from_euler(self.th,0.0,0.0)
		
		quaternion = Quaternion()
		quaternion.x = q_rot[1]
		quaternion.y = q_rot[2]
		quaternion.z = q_rot[0]
		quaternion.w = q_rot[3]
